                                    ...
                                    <table style="border-left: 1px solid #e5e5e5;">
                                        <tbody>
                                            <tr valign="top">
                                                ...
                                                <td class="content">
                                                    <input type="text" value="" maxlength="100" name="txt_firstName" id="txt_firstName"/><span>(*) </span>
                                                    <div class="warning" id="firstNameWarning">
                                                        Sorry, only letters(a-z, A-Z), periods (.), hyphens (-), single quote(') or space
                                                        are allowed.
                                                    </div>
                                                    <div class="warning" id="firstNameNullWarning"> Please enter a valid first name.</div>
                                                </td>
                                            </tr>
                                            <tr valign="top">
                                                <td class="label">Middle Name</td>
                                                <td class="content">
                                                    <input type="text" value="" maxlength="100" name="txt_middleName" id="txt_middleName"/>
                                                    <input type="hidden" value="true" name="oriMiddleName"/>
                                                    <div class="warning" id="middleNameWarning">
                                                        Sorry, only letters(a-z, A-Z), periods (.), hyphens (-), single quote(') or space
                                                        are allowed.
                                                    </div>
                                                </td>
                                            ...
                                            <tr valign="top">
                                                ...
                                                <td class="content">
                                                    <input type="text" value="" maxlength="100" name="txt_lastName" id="txt_lastName"><span>(*)</span>
                                                        <input type="hidden" value="true" name="oriLastName"/>
                                                        <div class="warning" id="lastNameWarning">
                                                            Sorry, only letters(a-z, A-Z), periods (.), hyphens (-), single quote(') or space
                                                            are allowed.</div>
                                                        <div class="warning" id="lastNameNullWarning"> Please enter a valid last name. </div>
                                                </td>
                                            </tr>
                                            <tr valign="top">
                                                <td class="label">Email</td>
                                                <td class="content">
                                                    <input type="text" value="" class="longblock" maxlength="1000" name="txt_email" id="txt_email"/>
                                                    <div class="example">
                                                        e.g. http://www.cs.cityu.edu.hk/~fyao/FrancesYao.jpg
                                                    </div>
                                                    <div class="warning" id="emailInvalidWarning">Please enter a valid email.</div> 
                                                </td>
                                            </tr>
                                            <!--<tr valign="top">
                                            ...
                                            <tr valign="top">
                                                ...
                                                <td class="content">
                                                    <input type="text" value="" class="longblock" maxlength="1000" name="txt_homepageUrl" id="txt_homepageUrl"/>                                                    
                                                    <div class="example">
                                                        e.g. http://www.cs.princeton.edu/
                                                    </div>
                                                    <div class="warning" id="homepageUrlInvalidWarning">
                                                        Please enter a valid homepage URL.
                                                    </div>
                                                    <div class="warning" id="homepageUrlWarning">
                                                        Sorry, this site is not allowed to be used as a homepage, please use another one.
                                                    </div>                                                    
                                                </td>
                                            </tr>
                                            <tr valign="top">
                                                ...
                                                <td class="content">
                                                    <input type="text" value="" class="longblock" maxlength="1000" name="txt_photoUrl" id="txt_photoUrl"/>
                                                    <div class="example">
                                                        e.g. http://www.cs.cityu.edu.hk/~fyao/FrancesYao.jpg
                                                    </div>
                                                    <div class="warning" id="photoUrlWarning">
                                                        Please enter a valid image URL.
                                                    </div>
                                                    <div class="warning" id="photoUrlDownloadFailWarning">
                                                        Sorry, we could not achieve this image, please provide another valid URL.
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr valign="top">
                                                ...
                                                <td class="content">
                                                    <textarea class="comment longblock" name="txt_comment" id="txt_comment"></textarea>
                                                </td>
                                            </tr>
                                            <tr valign="top">
                                                <td valign="top" colspan="2">
                                                    <div class="form-element nextstep-button" style=" margin-left: 150px;"">
                                                         <input id="submit_button_cancle" name="action" type="submit" value="cancel" class="g_button g_button_submit"/>
                                                        <input id="submit_button_complete" name="action" type="submit" value="complete" class="g_button g_button_submit"/>
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
